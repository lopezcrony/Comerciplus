                ...
                children: [
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        DetalleRow(
                          ...
                          label: 'Total',
                          value: '\$${formatoMoneda.format(purchase.valorCompra)}',
                        ),
                        const SizedBox(height: 12),
                        DetalleRow(
                  ...
                  ...details.map((item) {
                    return FutureBuilder<Products>(
                      future:
                          ProductService().fetchProductById(item.idProducto),
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                const SizedBox(height: 4),
                                Text(
                                  'Precio unitario: \$${formatoMoneda.format(item.precioCompraUnidad)}',
                                  style: GoogleFonts.poppins(),
                                ),
                                const SizedBox(height: 4),
                                Text(
                                  'Subtotal: \$${formatoMoneda.format(item.subtotal)}',
                                  style: GoogleFonts.poppins(
                                      fontWeight: FontWeight.w500),
                                ),
                              ],
